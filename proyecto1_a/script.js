window.onscroll = function() {
    ...
    // Calcular el porcentaje de scroll desde el final hacia el inicio
    let scrollPercentage = (maxScroll - scrollTop) / maxScroll;
    
    // Calcular los índices de color entre los que se encuentra
    ...
    // Calcular el porcentaje local de transición entre dos colores
