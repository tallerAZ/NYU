// Define the color transitions in an array (no need to change if you want to keep the same order)
const colors = [
  ...
  window.onscroll = function() {
    ...
    // Calcular el porcentaje de desplazamiento del scroll desde abajo hacia arriba
    let scrollPercentage = (maxScroll - scrollTop) / maxScroll;
  
    // Calcular el índice de color para la transición
    ...
    // Mostrar la información y la carta estelar al llegar al último color (negro)
